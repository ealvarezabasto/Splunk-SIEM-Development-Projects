# Install Splunk ES in AWS EC2 Instance (Ubuntu Linux)

This documents provides a comprehensive guide to set up Splunk on an AWS EC2 instance (Ubuntu Linux) using the UI-based approach and the command line. 
